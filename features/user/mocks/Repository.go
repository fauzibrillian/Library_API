...
func (_m *Repository) Register(newUser user.User) (user.User, error) {
...
func (_m *Repository) ResetPassword(input user.User) (user.User, error) {
	ret := _m.Called(input)
...
func (_m *Repository) SearchUser(userID uint, name string, page uint, limit uint) ([]user.User, uint, error) {
	...
	var r1 uint
	var r2 error
	if rf, ok := ret.Get(0).(func(uint, string, uint, uint) ([]user.User, uint, error)); ok {
		return rf(userID, name, page, limit)
	}
	if rf, ok := ret.Get(0).(func(uint, string, uint, uint) []user.User); ok {
	...
	if rf, ok := ret.Get(1).(func(uint, string, uint, uint) uint); ok {
